...
import { LayoutGrid, FileEdit, Rss, Bell, User, Zap, BarChart3 } from 'lucide-react';
...
export default function NavBar() {
    ...
    const defineButton = [
        ...
        { icon: <BarChart3 size={24} strokeWidth={1.5} />, alt: 'Statistics', route: '/statistics' },
    ...
    return (
        <nav className="flex items-center gap-3 px-8 py-2 my-4 bg-white/90 backdrop-blur-sm rounded-full shadow-lg">
